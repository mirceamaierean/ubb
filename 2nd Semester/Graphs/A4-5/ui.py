...
class UI:
    ...
    def print_menu(self):
        ...
        print("19. Using Prim's algorithm, find the minimum cost spanning tree of the graph, from a starting vertex")
        print("20. Print the minimum cost walk between two vertices in a DAG")
        print("21. Print the number of paths between two vertices in a DAG")
        print("22. Print hamiltonian cycle")
        print("23. Exit")
    ...
    def run(self):
        ...
        while True:
            ...
            if command == "1":
                ...
                self.print_minimum_cost_walk_in_dag()
            elif command == "21":
                self.print_number_of_paths()
            elif command == "22":
                self.print_hamiltonian_cycle()
            elif command == "23":
                filename = "graph" + \
