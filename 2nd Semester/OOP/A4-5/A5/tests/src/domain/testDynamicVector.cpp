...
void TestsDynamicVector::testDynamicVector()
{
  ...
  assert(vectorOfIntegers.checkIfElementIsInDynamicVector(20) == true);
  assert(vectorOfIntegers.checkIfElementIsInDynamicVector(77) == false);
  ...
  copyOfVectorOfIntegersThatReceivesValueBasedOnCopyAssignmentOperator = copyOfVectorOfIntegersThatReceivesValueBasedOnCopyAssignmentOperator;
