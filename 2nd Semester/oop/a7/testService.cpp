...
void TestsService::testService()
{
  ...
  serviceForClearingFiles.clearFile("testDB+CSV.db");
  serviceForClearingFiles.clearFile("WatchListDB+CSV.csv");
  testService(new DBRepository{"testDB+CSV.db"}, new CSVWatchList{"WatchListDB+CSV.csv"});
  serviceForClearingFiles.clearFile("testDB+HTML.db");
  serviceForClearingFiles.clearFile("WatchListDB+HTML.html");
  testService(new DBRepository{"testDB+HTML.db"}, new HTMLWatchList{"WatchListDB+HTML.html"});
}