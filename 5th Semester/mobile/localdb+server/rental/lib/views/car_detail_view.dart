...
class _CarDetailViewState extends State<CarDetailView> {
  ...
  Future<void> _reserveCar(BuildContext context) async {
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              'There was an error reserving the car. Please try again later.\nError: $e',
            ),
            actions: [
              TextButton(
                onPressed: () => Navigator.of(context).pop(),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: isLoading ? null : () => _reserveCar(context),
